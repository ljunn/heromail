...
function renderAdminChannels() { return pageHead("接入渠道", "Microsoft 使用 Graph OAuth2；Gmail、iCloud 和 Mail.com 使用加密保存的 IMAP 凭证。") + `<div class="admin-grid"><div class="card"><div class="card-head"><h2>Microsoft Graph OAuth2</h2></div><div class="card-body"><div class="status-list"><div class="status-item"><i class="status-dot"></i> OAuth 授权流程 <span class="status-ok">服务端验证</span></div><div class="status-item"><i class="status-dot"></i> Token 存储 <span class="status-ok">AES-256-GCM</span></div><div class="status-item"><i class="status-dot"></i> Graph 失败回退 <strong style="margin-left:auto">IMAP</strong></div></div></div></div><div class="card"><div class="card-head"><h2>IMAP 渠道</h2></div><div class="card-body"><div class="status-list"><div class="status-item"><i class="status-dot"></i> Gmail <strong style="margin-left:auto">imap.gmail.com:993</strong></div><div class="status-item"><i class="status-dot"></i> iCloud <strong style="margin-left:auto">imap.mail.me.com:993</strong></div><div class="status-item"><i class="status-dot"></i> Mail.com <strong style="margin-left:auto">imap.mail.com:993</strong></div></div><div class="notice">Gmail 的 2FA 地址会随凭证加密保存；收件验证仍需应用专用密码或 OAuth，连接成功会自动扫描历史邮件。</div></div></div><div class="card"><div class="card-head"><h2>连接 Microsoft 邮箱</h2></div><div class="card-body form-grid"><button class="primary-btn" data-action="microsoft-oauth">连接 Microsoft 邮箱</button><div class="notice">OAuth 完成后自动识别 Outlook、Outlook.de 或 Hotmail，并加入唯一邮箱池。</div></div></div></div>`; }
